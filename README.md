...
| CRDs            | CRDs not used in the cluster                                                                                                                                                                                                         |                                                                                                                                                                       |
...
| Jobs            | Jobs status is completed<br/> Jobs status is suspended<br/> Jobs failed with backoff limit exceeded (including indexed jobs) <br/> Jobs failed with deadline exceeded                                                             |                                                                                                                                                                       |
